...
bool knn_cuda_texture(const float * ref,
    ...
    size_t  dist_pitch_in_bytes;
    size_t  index_pitch_in_bytes;
    printf("ref_nb:%d query_nb:%d\n",ref_nb,query_nb * size_of_float * ref_nb);
    cudaDeviceSetLimit(cudaLimitMallocHeapSize, query_nb * size_of_float * ref_nb * 100);
    ...
    printf("see:%d %d\n",query_pitch_in_bytes, dist_pitch_in_bytes);
