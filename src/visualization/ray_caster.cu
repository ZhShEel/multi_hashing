...
//  if (flag) {
//    printf("camera_ray_dir: (%f %f %f)\n", camera_ray_dir.x, camera_ray_dir.y, camera_ray_dir.z);
//    printf("world_ray_dir: (%f %f %f)\n", world_ray_dir.x, world_ray_dir.y, world_ray_dir.z);
...
//      if (flag) {
//        printf("t: %f, pos_world: (%f %f %f), sdf: %f\n", t, world_sample_pos.x, world_sample_pos.y, world_sample_pos.z, voxel_query.sdf);
//      }
      /// Zero crossing exist
...
//                                  interpolated_color.z / 255.f, 1.0f);
            ...
            ray_caster_data.color [pixel_idx]
                    = make_float4(voxel_query.color.x / 255.f,voxel_query.color.y / 255.f,voxel_query.color.z / 255.f, 1.0f);
            ...
            if (ray_caster_params.enable_gradients) {
              ...
              ray_caster_data.surface[pixel_idx]
                      = make_float4(normal.z, normal.y, normal.x, 1.0f);
            }
