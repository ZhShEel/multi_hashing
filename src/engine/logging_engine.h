...
public:
  ...
  void WritePly(CompactMesh& mesh_m);
  void WritePly_Temp(CompactMesh& mesh_m, int t);
  ...
  void WriteMeshingTimeStamp(float time, float recycle_time, int frame_idx);
  void WriteRayCastingTimeStamp(float time, int frame_idx);
  void WriteMeshStats(int vtx_count, int tri_count, int frame_idx);
...
private:
  ...
  std::ofstream raycasting_time_file_;
