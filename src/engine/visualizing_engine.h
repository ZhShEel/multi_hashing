...
public:
  ...
  void Init(std::string, int width, int height, SensorParams &sensor_params);

  VisualizingEngine(std::string window_name, int width, int height, SensorParams &sensor_params);
...
private:
  ...
  bool enable_join_process = false;
