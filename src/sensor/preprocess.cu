...
void ValidateDepth(
  ...
  checkCudaErrors(cudaMemcpy(depth_data, (float *) depth_img.data,
  ...
  ValidateDepthKernel << < grid_size, block_size >> > (
      depth_data,
          width, height,
